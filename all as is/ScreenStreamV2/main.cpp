...
/** --> \ <-- this tells the compiler that the next line is a comment to btw \
i made this comments so i don't make compile mistakes \/
==============================================================================================
how to set up librares

code:blocks(optional){
link does not work rn
need:codeblocks-XXmingw-setup.exe
how:download like any normal exe file and run it
}
...
==============================================================================================
how to compile
this is the project linker sittings
build options -> linker settings -> link library
{
mswsock
ws2_32
gdi32
...
//this is the project search directory
build options -> search directory -> Compiler{
C:\c++\lib\boost
}

if you want it to work as wanted put this in the other linker settings{
-mwindows
}
================================================================================================
*/
